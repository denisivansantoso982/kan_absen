            ...
            itemBuilder: (context, index) => Container(
              ...
              child: Row(
                ...
                children: [
                  Column(
                    children: [
                      Row(
                        children: [
                          Text(
                            DateFormat('dd').format(agenda.theListOfAgenda[index].agenda_start),
                            style: TextStyleTemplate.boldPrimary(size: 20),
                          ),
                          Column(
                            children: [
                              Text(
                                DateFormat('MMMM').format(agenda.theListOfAgenda[index].agenda_start),
                                style: TextStyleTemplate.regularPrimary(size: 12),
                              ),
                              Text(
                                DateFormat('yyyy').format(agenda.theListOfAgenda[index].agenda_start),
                                style: TextStyleTemplate.regularPrimary(size: 12),
                              ),
                            ],
                          ),
                      ...
                      Text(
                        '${DateFormat('HH').format(agenda.theListOfAgenda[index].agenda_start)} : ${DateFormat('mm').format(agenda.theListOfAgenda[index].agenda_start)}',
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () => Navigator.of(context).pushNamed(DetailAgendaScreen.route, arguments: agenda.theListOfAgenda[index].agenda_uid),
                      child: Container(
                          ...
                          children: [
                            Expanded(
                              child: Wrap(
                                children: [
                                  Text(
                                    agenda.theListOfAgenda[index].agenda_name,
                  ...
                  Column(
                    children: [
                      Row(
                        children: [
                          Text(
                            DateFormat('dd').format(agenda.theListOfAgenda[index].agenda_end),
                            style: TextStyleTemplate.boldPrimary(size: 20),
                          ),
                          Column(
                            children: [
                              Text(
                                DateFormat('MMMM').format(agenda.theListOfAgenda[index].agenda_end),
                                style: TextStyleTemplate.regularPrimary(size: 12),
                              ),
                              Text(
                                DateFormat('yyyy').format(agenda.theListOfAgenda[index].agenda_end),
                                style: TextStyleTemplate.regularPrimary(size: 12),
                              ),
                            ],
                          ),
                      ...
                      const SizedBox(height: 2,),
                      Text(
                        '${DateFormat('HH').format(agenda.theListOfAgenda[index].agenda_end)} : ${DateFormat('mm').format(agenda.theListOfAgenda[index].agenda_end)}',
                        style: TextStyleTemplate.regularPrimary(size: 14),
                      ),
                    ],
                  ),
